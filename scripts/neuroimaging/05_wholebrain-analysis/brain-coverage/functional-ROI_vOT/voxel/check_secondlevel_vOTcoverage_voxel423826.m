...
subj_csv = fullfile(results_dir, "check_secondLevelCoverage", "voxel_423826.csv");
...
% Save results as csv
output_file = fullfile(results_dir, "check_secondLevelCoverage", "vOT_second-level-coverage_voxel423826.csv");
