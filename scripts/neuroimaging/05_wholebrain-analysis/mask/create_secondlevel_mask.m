...
mask_file = fullfile(proj_dir, "results", "wholebrain-analysis", "mask", "non-conflicting_vs_fixation", "mask.nii");
...
group_mask_hdr.fname = char(fullfile(proj_dir, "results", "wholebrain-analysis", "secondlevel_mask.nii"));
