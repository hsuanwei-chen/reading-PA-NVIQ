...
raw_dir = fullfile(root_dir, 'datasets', '2_ds001894', 'bids');

% Define preprocessing directory, where you want to copy your data to
proc_dir = fullfile(proj_dir, 'data', 'neuroimaging', 'preprocessed', 'ds001894');
...
idx = strcmp(subj_tbl.dataset, 'ds001894') & strcmp(subj_tbl.exclude, 'NA');
