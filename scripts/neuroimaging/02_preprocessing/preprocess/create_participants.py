...
ds001486_df["participant_label"] = ds001486_df["participant_id"]
ds001486_df["participant_label"].to_csv(
    "ds001486_participants_preprocess.txt", 
...
ds001894_df["participant_label"] = ds001894_df["participant_id"]
ds001894_df["participant_label"].to_csv(
    "ds001894_participants_preprocess.txt", 
    index = False, header = False
)
...
ds002236_df["participant_label"] = ds002236_df["participant_id"]
ds002236_df["participant_label"].to_csv(
    "ds002236_participants_preprocess.txt", 
    index = False, header = False
)
...
ds006239_df["participant_label"] = ds006239_df["participant_id"]
ds006239_df["participant_label"].to_csv(
    "ds006239_participants_preprocess.txt", 
    index = False, header = False
)