...
participants_rds          <- here(merged_dir, "merged_participants_motionQC-coverage-acc-vOT.rds")
...
# Set output files
output_participants_rds <- here(merged_dir, "preregistration-amendment_participants.rds")
output_participants_csv <- here(merged_dir, "preregistration-amendment_participants.csv")
